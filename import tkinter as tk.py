...
def diminuir():
    ...
    margem.pack()
    botao_acrescentar = tk.Button(root, bd='#FFFFFF', text='+',
                                  font=('Montserrat',16, 'bold'),padx=10,command=acrescentar)
    
    botao_acrescentar.pack()
    contagem_click = tk.Label(root, text=numero,fg='#FFFFFF' , bd='#1d1d1d', font=('Montserrat', 16 , 'bold'))

    contagem_click.pack()
    botao_diminuir = tk.Button(root, bd='#FFFFFF', text='-',
